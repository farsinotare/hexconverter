...
},{"backbone":10,"jquery-untouched":21,"models/data":2,"views/binary":6,"views/bytes":7,"views/hex":8}],2:[function(require,module,exports){
var Backbone = require('backbone');
...
var Data = Backbone.Model.extend({
  ...
  initialize: function() {
    ...
    this.on('convert:hex2bytes', function(v) { this.hex2bytes(v) });
...
},{"backbone":10,"binstring":11}],3:[function(require,module,exports){
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<label for=\"binary\">Binary</label><input name=\"binary\" id=\"binary-input\"></input>\n";
  });

},{"hbsfy/runtime":20}],4:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<label for=\"bytes\">Bytes</label><input name=\"bytes\" id=\"bytes-input\"></input>\n";
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<label for=\"hex\">Hex</label><input name=\"hex\" id=\"hex-input\"></input>\n";
  });
...
},{"backbone":10,"backbone.stickit":9,"templates/binary.hbs":3}],7:[function(require,module,exports){
var Backbone = require('backbone');
var Stickit = require('backbone.stickit');
var conv = require('binstring');
...
},{"backbone":10,"backbone.stickit":9,"binstring":11,"convert-hex":12,"templates/bytes.hbs":4}],8:[function(require,module,exports){
var Backbone = require('backbone');
var $ = Backbone.$;
...
},{"backbone":10,"backbone.stickit":9,"convert-hex":12,"templates/hex.hbs":5}],9:[function(require,module,exports){
...
},{"backbone":10,"underscore":22}],10:[function(require,module,exports){
//     Backbone.js 1.1.2
